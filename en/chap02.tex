...
\img{TTSarch.png}{0.9}{Overview of a typical statistical Text-to-speech system architecture. The text is first analysed and translated to phonetic transcription. Then, the acoustic parameters are estimated. Finally, the speech is synthesized.}{ttsarch}
